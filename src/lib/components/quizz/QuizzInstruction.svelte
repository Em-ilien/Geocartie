<script>
    ...
    function loadNewInstruction() {
        ...
        instruction.label = "Cherchez " + randomDepartment.prefix + randomDepartment.name + " sur la carte (" + randomDepartment.id + ")";
...
<div class="quizz-instruction-hider" in:fly={{y: 0, x: "100%", duration: 700}} out:fly={{y: 0, x: "100%", duration: 700}}>
